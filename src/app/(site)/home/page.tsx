  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">홈</h1>
        ...
        <section className="mb-12">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-lg mb-6">최대 70% 할인! 오늘만의 특별한 기회를 놓치지 마세요.</p>
        ...
        <section className="mb-12">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">베스트 상품</h2>
                               <a href="/product" className="text-orange-500 hover:text-orange-600 font-medium">더보기 →</a>
          </div>
